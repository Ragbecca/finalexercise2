...
const TaskDashboard = (props) => {
    return <div id="dashboard">
        ...
        <div id="dashboard-flex">
            <ActiveTasks globalTasks={props.globalTasks} refreshGlobalTasks={props.setRefreshGlobalTasks} />
            <div className="dashboard-2-big-segments">
                <ProgressTasks globalTasks={props.globalTasks} />
                <FinishedTasks globalTasks={props.globalTasks} refreshGlobalTasks={props.setRefreshGlobalTasks} />
            </div>
        </div>
    </div>
}
